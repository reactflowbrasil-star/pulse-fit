...
const ENV_CHECKS: EnvCheck[] = [
  ...
  { key: "SUPABASE_ANON_KEY", required: true, description: "Chave anon do Supabase" },
  {
    ...
    required: false,
    description: "Chave service_role (necessária para operações admin e webhook)",
  },
  ...
  // Auth (obrigatórias para funcionalidade)
  {
    ...
    required: true,
    description: "Chave publishable do Supabase (auth middleware)",
  },
  ...
  // WhatsApp (opcionais, mas necessárias para envio de mensagens)
  {
    ...
    required: false,
    description: "URL da Evolution API para envio/recebimento de mensagens",
  },
  ...
  { key: "EVOLUTION_INSTANCE", required: false, description: "Nome da instância na Evolution API" },
  {
    ...
    required: false,
    description: "Token para autenticar webhooks recebidos",
  },
  ...
  // Bot externo (fallback)
  {
    key: "BOT_URL",
    required: false,
    description: "URL do bot server externo (fallback para envio de código)",
  },
  ...
  // AI
  {
    key: "LOVABLE_API_KEY",
    required: false,
    description: "Chave do Lovable AI Gateway (coach virtual)",
  },
];
