...
const cardVariants: Record<string, string> = {
  default: "rounded-2xl bg-surface-card border border-border/60 shadow-card",
  elevated: "rounded-2xl bg-surface-card border border-border/60 shadow-elevated",
    ...
    return (
      <div
        ...
        className={`${cardVariants[variant]} ${
          hover
            ? "transition-all duration-200 hover:-translate-y-0.5 hover:shadow-elevated cursor-pointer"
            : ""
        } ${className}`}
        {...props}
      >
