        ...
        <main className="flex-1 space-y-5 px-5 py-5 pb-8 overflow-y-auto">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex gap-2">
              ...
              <Link
                to="/profile"
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-surface-elevated border border-border overflow-hidden"
              >
          ...
          <StaggerContainer className="grid grid-cols-2 gap-3">
            ...
            <StaggerItem>
              <KPICard
                ...
                unit=""
                progress={steps.current / steps.goal}
            ...
            <StaggerItem>
              <KPICard
                ...
                label="Ativo"
                value={`${activeMin.current}`}
                unit="min"
                progress={activeMin.current / activeMin.goal}
                color="text-primary"
              />
            </StaggerItem>
            <StaggerItem>
          ...
          <StaggerContainer className="grid grid-cols-2 gap-3">
            <StaggerItem>
              <Link
                to="/browse"
                className="group block rounded-2xl bg-gradient-to-br from-primary/10 via-surface-card to-surface-card border border-primary/10 p-4 transition-all hover:-translate-y-0.5 hover:shadow-lg active:scale-[0.98]"
              >
            ...
            <StaggerItem>
              <Link
                to="/rewards"
                className="group block rounded-2xl bg-gradient-to-br from-primary to-primary-dark p-4 text-primary-foreground transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/20 active:scale-[0.98]"
              >
