...
export const Route = createFileRoute("/done")({
  head: () => ({ meta: [{ title: "Concluído! — Pulse Fit" }] }),
  component: () => {
      ...
      <MobileFrame>
        <PageTransition>
          <main className="flex flex-1 flex-col items-center justify-center px-6 text-center">
            ...
            <h2 className="font-display text-3xl font-bold">Concluído!</h2>
            <p className="mt-2 text-sm text-text-tertiary">Treino finalizado com sucesso!</p>
